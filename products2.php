...
<body>
    ...
    <div class="products-container">
        ...
        <div class="product-card">
            <a href="product1.php">
                <img src="imgProducts/IMG_4984_bg.png" alt="Sweatshirt Black" class="product-image">
            </a>
            <div class="product-info">
                <h3 class="product-title">Blazer Tom</h3>
        ...
        <div class="product-card">
            <a href="product2.php">
                <img src="imgProducts/IMG_5731_bg.png" alt="Sweatshirt Black" class="product-image">
            </a>
            <div class="product-info">
                <h3 class="product-title">Blazer Virgil</h3>
        ...
        <div class="product-card">
            <a href="product3.php">
                <img src="imgProducts/IMG_5781_bg.png" alt="Sweatshirt Black" class="product-image">
            </a>
            <div class="product-info">
                <h3 class="product-title">Fato humphrey</h3>
        ...
        <div class="product-card">
            <a href="product4.php">
                <img src="imgProducts/IMG_5804_bg.png" alt="Sweatshirt Black" class="product-image">
            </a>
            <div class="product-info">
                <h3 class="product-title">Calça chino</h3>
                <p class="product-price">95,00 €</p>
            </div>
        </div>
        <!-- PRODUCT 5 -->
        <div class="product-card">
            <a hrerf="product5.php">
                <img src="imgProducts/IMG_5835_bg.png" alt="Sweatshirt Black" class="product-image">
            </a>
            <div class="product-info">
                <h3 class="product-title">Blazer etiem</h3>
        ...
        <div class="product-card">
            <a href="product6.php">
                <img src="imgProducts/IMG_5872_bg.png" alt="Sweatshirt Black" class="product-image">
            </a>
            <div class="product-info">
                <h3 class="product-title">Blazer butcher</h3>
