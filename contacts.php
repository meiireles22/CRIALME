    ...
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        ...
        <div class="container" style="max-width: 100% !important;">
            ...
            <div class="map-section">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2999.3611530228295!2d-8.360109923438722!3d41.25747180404278!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd248c535badf19d%3A0xa93c7f0225356f1e!2zQ3JpYWxtZSAtIEZhYnJpY2HDp8OjbywgRXhwb3J0YcOnw6NvIGUgSW1wb3J0YcOnw6NvIGRlIENvbmZlY8Onw7VlcywgTGRh!5e0!3m2!1spt-PT!2spt!4v1733153528491!5m2!1spt-PT!2spt" 
                    allowfullscreen=""
                    loading="lazy"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="d-flex d-lg-none list-unstyled mt-3">
                    <div class="login me-3 align-items-center">
                        <li>
                            <?php
                                ...
                                ?>
                            <a class="nav-link nav-link-ltr text-white" href="loggin.php" color="white"><svg class="man" width="15"
                                    height="15">
                                ...
                                ?>
                            <a class="nav-link nav-link-ltr" href="logout.php"><svg class="man" width="15"
                                    height="15">
                                    <use xlink:href="#man"></use>
                    ...
                    <div class="search me-3">
                        <li class="search-box"><a class="nav-link nav-link-ltr text-white search-button" href="#">C &nbsp; SEARCH</a></li>
                    </div>
                    <!-- CARRINHO -->
                    <div class="cart me-3">
                        <li><a class="nav-link nav-link-ltr text-white" href="#" data-bs-toggle="offcanvas"
                ...
                <ul class="navbar-nav d-flex ms-auto me-5 mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link nav-link-ltr text-white text-white" href="about-us.php">ABOUT</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-ltr text-white text-white" href="products.php">PRODUCTS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-ltr text-white text-white" href="contacts.php">CONTACTS</a>
                    </li>
                </ul>
            </div>

           <!-- Lista de navegação que exibe LOGIN ou LOGOUT dependendo do estado da sessão do utilizador. -->                     
            <ul class="navbar-nav d-lg-block d-none list-unstyled">
                <div class="login">
                    <li>
                        <?php
                            if (!isset($_SESSION['email'])) {
                            ?>
                        <a class="nav-link nav-link-ltr text-white" href="loggin.php"><svg class="man" width="15"height="15">
                ...
                <p></p>
                <p></p>
                <p>Rua do Facho nº 41</p>
                <p>4580-627 Sobrosa — Paredes</p>
                <p>Opening hours from Monday to Friday:</p>
                <p>9h00-12h30 / 14h00-18h00</p>
                <p>Tel.: <a href="tel:+351255868200">(+351) 255 868 200</a></p>
                <p><a href="mailto:geral@crialme.pt">geral@crialme.pt</a></p>
            </div>
        </div>
    </body>
</html>
