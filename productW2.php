...
<body>
    ...
    <div class="product-container">
        ...
        <div class="product-image">
            <img src="imgProducts/IMG_2.png" alt="Produto">
        </div>

        <!-- Detalhes do produto -->
        <div class="product-details">
            <h1>Blazer bruma</h1>
            <p>Blazer feminino estruturado, com design atemporal e caimento impecável, perfeito para compor looks formais e sofisticados.</p>
            ...
            <a href="productW2.php"> <button onclick="adicionarAoCarrinho(8)">Adicionar ao Carrinho</button> </a>
