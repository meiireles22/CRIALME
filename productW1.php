...
<body>
    ...
    <div class="product-container">
        ...
        <div class="product-image">
            <img src="imgProducts/IMG_1.png" alt="Produto">
        </div>

        <!-- Detalhes do produto -->
        <div class="product-details">
            <h1>Blazer rose</h1>
            <p>Blazer feminino de alfaiataria com fechamento transpassado e botões duplos, ideal para um look sofisticado e elegante.</p>
            ...
            <a href="productW1.php"> <button onclick="adicionarAoCarrinho(7)">Adicionar ao Carrinho</button> </a>
