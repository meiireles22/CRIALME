...
<body>
    ...
    <div class="product-container">
        ...
        <div class="product-image">
            <img src="imgProducts/IMG_4.png" alt="Produto">
        </div>

        <!-- Detalhes do produto -->
        <div class="product-details">
            <h1>Calça pantalona</h1>
            <p>Calças de alfaiataria femininas com pregas, confeccionadas em tecido sofisticado para um caimento elegante e confortável.</p>
            ...
            <a href="productW4.php"> <button onclick="adicionarAoCarrinho(10)">Adicionar ao Carrinho</button> </a>
