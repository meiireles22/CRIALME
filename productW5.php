...
<body>
    ...
    <div class="product-container">
        ...
        <div class="product-image">
            <img src="imgProducts/IMG_5.png" alt="Produto">
        </div>

        <!-- Detalhes do produto -->
        <div class="product-details">
            <h1>Blazer divinal</h1>
            <p>Blazer feminino azul-marinho, clássico e elegante, com lapelas finas, botão único e bolsos discretos.</p>
            ...
            <a href="productW5.php"> <button onclick="adicionarAoCarrinho(11)">Adicionar ao Carrinho</button> </a>
