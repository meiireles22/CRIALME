...
<head>
    ...
    <!-- Style Sheet ================================================== -->
    <link rel="stylesheet" href="produCts.css/product1.css">
...
<body>
    ...
    <div class="product-container">
        ...
        <div class="product-image">
            <img src="imgProducts/IMG_6.png" alt="Produto">
        </div>

        <!-- Detalhes do produto -->
        <div class="product-details">
            <h1>Fato star Red</h1>
            <p>Conjunto feminino elegante em tom vermelho, composto por blazer de corte clássico e calça de alfaiataria reta. Ideal para um visual sofisticado e moderno.</p>
            <p class="price">140,00 €</p>
            <div class="sizes">
                <p>Selecionar tamanho:</p>
                <div class="sizes-container">
                    <input type="radio" id="size-xs" name="size" class="size-option" value="XS">
                    <label for="size-xs" class="size-label">XS</label>

                    <input type="radio" id="size-s" name="size" class="size-option" value="S">
                    ...
                    <input type="radio" id="size-xxl" name="size" class="size-option" value="XXL">
                    <label for="size-xxl" class="size-label">XXL</label>
                </div>
            </div>
            <div class="add-tocart">
            <a href="productW6.php"> <button onclick="adicionarAoCarrinho(12)">Adicionar ao Carrinho</button> </a>
                    ...
                    <script>
                        function adicionarAoCarrinho(produto_id) {
                            ...
                            xhr.send("produto_id=" + produto_id);
                        }
                    </script>
            </div>
        </div>
