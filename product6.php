...
<head>
    ...
    <!-- Style Sheet ================================================== -->
    <link rel="stylesheet" href="produCts.css/product6.css">
...
<body>
    ...
    <div class="product-container">
        ...
        <div class="product-image">
            <img src="imgProducts/IMG_5872_bg.png" alt="Produto">
        </div>

        <!-- Detalhes do produto -->
        <div class="product-details">
            <h1>Blazer butcher</h1>
            <p>Casaco em azul-escuro, combinando elegância e versatilidade. Perfeito para um look sofisticado, adaptável a diferentes ocasiões.</p>
            ...
            <a href="product6.php"> <button onclick="adicionarAoCarrinho(6)">Adicionar ao Carrinho</button> </a>
