...
<body>
    ...
    <div class="product-container">
        ...
        <div class="product-image">
            <img src="imgProducts/IMG_3.png" alt="Produto">
        </div>

        <!-- Detalhes do produto -->
        <div class="product-details">
            <h1>Pantalona gold</h1>
            <p>Calças elegantes de corte reto para mulher, feitas com tecidos ecológicos para um estilo sofisticado e sustentável.</p>
            ...
            <a href="productW3.php"> <button onclick="adicionarAoCarrinho(9)">Adicionar ao Carrinho</button> </a>
