<?php 
session_start();  // Inicia a sessão para armazenar informações entre requisições do utilizador .
?>
<!DOCTYPE html> 
<html lang="pt">
...
<head>
    ...
    <!-- Estilos específicos do cabeçalho -->
        <style>.myheader { background: rgba(14, 38, 57, .95) }</style>
</head>
...
<body style=" padding-top:100px;">
  ...
  <!-- Definição de ícones SVG para reutilização em vários elementos da página -->
    ...
    <div class="empresa">
        <h1>EMPRESA</h1>
        <p>Fundada em 1984, a Crialme distingue-se atualmente na indústria têxtil como uma empresa de referência mundial a nível de alfaiataria para homem, pela sua flexibilidade e capacidade de adaptação às tendências da moda e do mercado em geral. Inicialmente dedicada à confeção de calças de homem clássicas, após constantes investimentos em mecanismos e infraestruturas, assim como na formação qualificada dos seus colaboradores, depressa se adaptou às exigências do mercado, passando a oferecer um maior leque de produtos. A experiência e idoneidade dos gestores são sustentadas por uma dinâmica equipa comercial, que, através de um follow-up completo, disponibiliza informações em tempo real de cada passo das coleções/produções, privilegiando a orientação para o cliente.</p>
    </div>
    ...
    <section class="details">
        <div class="detail">
            <h2>MISSÃO</h2>
            <p>Adicionar valor ao produto com qualidade e constante aperfeiçoamento, através de meios inovadores, por forma a garantir o sucesso dos nossos clientes e o crescimento sustentável da organização.</p>
        </div>
        <div class="divider-vertical"></div>
        <div class="detail">
            <h2>VISÃO</h2>
            <p>Reconhecimento por parte dos nossos clientes, colaboradores e fornecedores como uma organização de referencia em inovação, estilo e qualidade, que se apresenta como a melhor solução na indústria da confeção.</p>
        </div>
        <div class="divider-vertical"></div>
        <div class="detail">
            <h2>VALORES</h2>
            <p>Focalização no cliente
                Valorização dos colaboradores
                Inovação e criatividade
                Bom senso e simplicidade dos processos
                Trabalho em equipa
                Responsabilidade social e ambiental</p>
        </div>
    </section>

     <!-- Inclusão de scripts para funcionalidades interativas -->
