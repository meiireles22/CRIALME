...
<head>
    ...
    <!-- Style Sheet ================================================== -->
    <link rel="stylesheet" href="produCts.css/product5.css">
...
<body>
    ...
    <div class="product-container">
        ...
        <div class="product-image">
            <img src="imgProducts/IMG_5835_bg.png" alt="Produto">
        </div>

        <!-- Detalhes do produto -->
        <div class="product-details">
            <h1>Blazer etiem</h1>
            <p>Casaco azul-escuro elegante e versátil, perfeito para um look sofisticado em diversas ocasiões.</p>
            ...
            <a href="product5.php"> <button onclick="adicionarAoCarrinho(5)">Adicionar ao Carrinho</button> </a>
