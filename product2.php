...
<head>
    ...
    <!-- Style Sheet ================================================== -->
    <link rel="stylesheet" href="produCts.css/product2.css">
...
<body>
    ...
    <div class="product-container">
        ...
        <div class="product-image">
            <img src="imgProducts/IMG_5731_bg.png" alt="Produto">
        </div>

        <!-- Detalhes do produto -->
        <div class="product-details">
            <h1>Blazer Virgil</h1>
            <p>Blazer masculino azul-marinho, com corte slim e fechamento por dois botões. Ideal para um look casual elegante.</p>
            ...
            <a href="product2.php"> <button onclick="adicionarAoCarrinho(2)">Adicionar ao Carrinho</button> </a>
