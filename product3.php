...
<head>
    ...
    <!-- Style Sheet ================================================== -->
    <link rel="stylesheet" href="produCts.css/product3.css">
...
<body>
    ...
    <div class="product-container">
        ...
        <div class="product-image">
            <img src="imgProducts/IMG_5781_bg.png" alt="Produto">
        </div>

        <!-- Detalhes do produto -->
        <div class="product-details">
            <h1>Fato humphrey</h1>
            <p>Conjunto elegante com casaco azul-marinho de abotoamento duplo e calça de alfaiataria. Sofisticação e versatilidade para diversas ocasiões.</p>
            ...
            <a href="product3.php"> <button onclick="adicionarAoCarrinho(3)">Adicionar ao Carrinho</button> </a>
