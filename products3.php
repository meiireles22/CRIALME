...
<body>
    ...
    <!-- PRODUCTS CONTAINER CONTEM TODOS OS MEUS PRODUTOS -->
    <div class="products-container">
        <!-- PRODUCT 1 -->
        <div class="product-card">
            <a href="productW1.php">
                <img src="imgProducts/IMG_1.png" alt="Sweatshirt Black" class="product-image">
            </a>
            <div class="product-info">
                <h3 class="product-title">Blazer rose</h3>
        ...
        <!-- PRODUCT 2 -->
        <div class="product-card">
            <a href="productW2.php">
                <img src="imgProducts/IMG_2.png" alt="Sweatshirt Black" class="product-image">
            </a>
            <div class="product-info">
                <h3 class="product-title">Blazer bruma</h3>
        ...
        <!-- PRODUCT 3 -->
        <div class="product-card">
            <a href="productW3.php">
                <img src="imgProducts/IMG_3.png" alt="Sweatshirt Black" class="product-image">
            </a>
            <div class="product-info">
                <h3 class="product-title">Pantalona gold</h3>
        ...
        <!-- PRODUCT 4 -->
        <div class="product-card">
            <a href="productW4.php">
                <img src="imgProducts/IMG_4.png" alt="Sweatshirt Black" class="product-image">
            </a>
            <div class="product-info">
                <h3 class="product-title">Calça pantalona</h3>
        ...
        <!-- PRODUCT 5 -->
        <div class="product-card">
            <a hrerf="productW5.php">
                <img src="imgProducts/IMG_5.png" alt="Sweatshirt Black" class="product-image">
            </a>
            <div class="product-info">
                <h3 class="product-title">Blazer divinal</h3>
        ...
        <!-- PRODUCT 6 -->
        <div class="product-card">
            <a href="productW6.php">
                <img src="imgProducts/IMG_6.png" alt="Sweatshirt Black" class="product-image">
            </a>
            <div class="product-info">
                <h3 class="product-title">Fato star Red</h3>
