...
<head>
    ...
    <!-- Style Sheet ================================================== -->
    <link rel="stylesheet" href="produCts.css/product4.css">
...
<body>
    ...
    <div class="product-container">
        ...
        <div class="product-image">
            <img src="imgProducts/IMG_5804_bg.png" alt="Produto">
        </div>

        <!-- Detalhes do produto -->
        <div class="product-details">
            <h1>Calça chino</h1>
            <p>Calça branca de alfaiataria, elegante e versátil. Ideal para composições sofisticadas e modernas.</p>
            ...
            <a href="product4.php"> <button onclick="adicionarAoCarrinho(4)">Adicionar ao Carrinho</button> </a>
